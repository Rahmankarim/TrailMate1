      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            region: dest.region || "gilgit-baltistan",
            difficulty: dest.difficulty || "moderate",
            duration: dest.duration || "",
            price: dest.price?.toString() || "",
            maxGroupSize: dest.maxGroupSize?.toString() || "",
            altitude: dest.altitude || "",
            bestSeason: dest.bestSeason || [],
            highlights: dest.highlights?.length ? dest.highlights : [""],
            included: dest.included?.length ? dest.included : [""],
            notIncluded: dest.notIncluded?.length ? dest.notIncluded : [""],
  ...
  return (
    <div className="flex min-h-screen bg-secondary">
      ...
      <div className="flex-1 ml-64">
        <DashboardTopbar title="Edit Destination" />
